...
![CI Tests](https://github.com/vladyspavlov/tacticalrmm/actions/workflows/ci-tests.yml/badge.svg?branch=develop)
[![codecov](https://codecov.io/gh/vladyspavlov/tacticalrmm/branch/develop/graph/badge.svg?token=8ACUPVPTH6)](https://codecov.io/gh/vladyspavlov/tacticalrmm)
[![Code style: black](https://img.shields.io/badge/code%20style-black-000000.svg)](https://github.com/python/black)

Tactical RMM is a remote monitoring & management tool, built with Django and Vue.\
It uses an [agent](https://github.com/vladyspavlov/rmmagent) written in golang and integrates with [MeshCentral](https://github.com/Ylianst/MeshCentral)
